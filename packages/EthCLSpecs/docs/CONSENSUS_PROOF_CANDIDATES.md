...
| `convertBuilderIndexToValidatorIndex` | `Gloas/Operations.lean:415`          | Inverse of `toBuilderIndex`/`isBuilderIndex`; the round trip should hold for every builder index                                                                                                                       |
