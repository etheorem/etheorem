...
`EthCLSpecs.Gloas.getPtc` (`Gloas/Operations.lean:390-407`) reads the cached
...
theorem getPtcElseOffset_lt_next_slot [Preset] {slot curSlot : Slot}
  ...
  have hmono : slot.toNat / slotsPerEpoch ≤ curSlot.toNat / slotsPerEpoch :=
    Nat.div_le_div_right (by omega)
  have hdiv : slot.toNat / slotsPerEpoch = curSlot.toNat / slotsPerEpoch :=
