...
> Validated against the pyspec test vectors for three forks (Fulu,
> Gloas, Heze). What is proved is in [Verification
...
| --- | --- | --- | --- | --- |
| `EthCLSpecs.Fulu` | 3 | 6 | 158 | 158 |
| `EthCLSpecs.Gloas` | 9 | 22 | 209 | 109 |
| `EthCLSpecs.Heze` | 1 | 8 | 218 | 12 |
| **Total** | 13 | 36 | 585 | 279 |
